...
import org.opendaylight.l2switch.cache.FlowCache;
...
public class FlowWriterServiceImpl implements FlowWriterService {
  ...
  public void addMacToMacFlow(MacAddress sourceMac, MacAddress destMac, NodeConnectorRef destNodeConnectorRef) {
    ...
    _logger.info("FlowCache: Add Mac to Mac flow ");
    ...
    FlowCache.addToCache(sourceMac.getValue(), "{"+flowPriority+","+destMac+"}");
    _logger.warn("FLOW MAC TO MAC TABLE KEY"+ flowTableId);
  }
